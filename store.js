...
function addItemToCart(title, price, imageSrc) {
  ...
  for (var i = 0; i < cartItemNames.length; i++) {
    if(cartItemNames[i].innerText == title) {
      ...
      cartItemNames[i].parentElement.parentElement.getElementsByClassName('cart-quantity-input')[0].value = parseFloat(cartItemNames[i].parentElement.parentElement.getElementsByClassName('cart-quantity-input')[0].value) + 1
      updateCartTotal()
      return
    }
  }
